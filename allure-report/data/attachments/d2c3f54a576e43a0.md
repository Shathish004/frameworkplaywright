...
- Name: visualtesting\visual.spec.ts >> Shopping Site
- Location: tests\visualtesting\visual.spec.ts:3:5
...
Received has value: {"data": [137, 80, 78, 71, 13, 10, 26, 10, 0, 0, …], "type": "Buffer"}
```
            ...
            - generic [ref=e179]:
              - heading "14.1-inch Laptop" [level=2] [ref=e180]:
                - link "14.1-inch Laptop" [ref=e181] [cursor=pointer]:
                  - /url: /141-inch-laptop
              - generic "1646 review(s)" [ref=e182]
              - generic [ref=e185]:
...
```ts
  ...
  2  | 
  3  | test('Shopping Site', async ({ page }) => {
  4  | 
  5  |     //test.setTimeout(6000);
  6  |     await page.goto('https://demowebshop.tricentis.com/');
> 7  |      expect(await page.screenshot()).toMatch("home.png");
     |                                      ^ TypeError: expect(received).toMatch(expected)
  8  | 
  9  | 
  10 | 
